...
/*   Updated: 2025/02/04 16:08:11 by risattou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_help(char **all)
{
	...
	buff = ft_substr_gnl(*all, i + 1, (ft_strlen_gnl(*all) - i));
	if (!buff)
	{
		free(line);
		free(*all);
