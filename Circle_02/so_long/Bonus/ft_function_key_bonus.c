...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_function_key_bonus.c                            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: risattou <risattou@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/24 19:28:24 by risattou          #+#    #+#             */
/*   Updated: 2025/03/10 21:55:04 by risattou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_side_left_on(t_map *all)
{
	if (all->time < 2)
	{
...
static void	ft_side_right_on(t_map *all)
{
	if (all->time < 2)
	{
